...
class Settings(BaseSettings):
    ...
    search_result_limit: int = Field(default=80, ge=1, le=200)
    public_search_fallback_enabled: bool = True
    public_search_max_queries: int = Field(default=30, ge=1, le=60)
    ...
    crawler_timeout_seconds: float = Field(default=25, ge=5, le=120)
    crawler_max_pages_per_domain: int = Field(default=12, ge=1, le=30)
