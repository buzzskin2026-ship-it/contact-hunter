...
class SearchJob(Base):
    ...
    requested_fields: Mapped[list[str]] = mapped_column(JSON, default=lambda: ["email", "phone"])
    ...
    logs: Mapped[list["CrawlLog"]] = relationship(back_populates="job", cascade="all, delete-orphan")
...
class Contact(Base):
    ...
    job_id: Mapped[str | None] = mapped_column(ForeignKey("search_jobs.id", ondelete="SET NULL"), nullable=True)
